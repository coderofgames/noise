 ...
 * "Portions Copyright (C) David Nash, 2004"
 */
#ifndef _3DMATH_H
#define _3DMATH_H
...
// Note: This is a left handed cross product - required for the coordinate system
#define CrossL( vout, v1, v2 ) vout.x = ( v1.y*v2.z - v1.z*v2.y );\
